...
class RestructureApprovedMail extends Mailable
{
    ...
    public function build()
    {
            ...
            <body style='margin: 0; padding: 0; background-color: #f5f7fa; font-family: -apple-system, BlinkMacSystemFont, \"Segoe UI\", Roboto, \"Helvetica Neue\", Arial, sans-serif;'>
                <div style='max-width: 600px; margin: 0 auto; background-color: #ffffff;'>
                    ...
                    <div style='background: linear-gradient(135deg, #4CAF50 0%, #2E7D32 100%); padding: 40px 20px; text-align: center;'>
                        ...
                        <h1 style='margin: 0; color: #ffffff; font-size: 28px; font-weight: 600;'>✓ Restructuring Approved</h1>
                        <p style='margin: 10px 0 0 0; color: rgba(255,255,255,0.9); font-size: 14px;'>Approved on {$approvedDate}</p>
                    </div>
                    ...
                    <div style='padding: 40px 30px;'>
                        <p style='margin: 0 0 30px 0; color: #555; font-size: 16px;'>
                            ...
                            The project restructuring request has been approved by the Regional Director. The changes are now in effect.
                        </p>

                        <!-- Project Information Card -->
                        <div style='background-color: #f8f9fa; border-left: 4px solid #4CAF50; padding: 20px; margin: 30px 0; border-radius: 4px;'>
                            <h3 style='margin: 0 0 15px 0; color: #4CAF50; font-size: 16px; font-weight: 600;'>Project Information</h3>
                        ...
                        <div style='background-color: #f8f9fa; border-left: 4px solid #4CAF50; padding: 20px; margin: 30px 0; border-radius: 4px;'>
                            <h3 style='margin: 0 0 15px 0; color: #4CAF50; font-size: 16px; font-weight: 600;'>Restructuring Details</h3>
                            ...
                            <div style='margin-bottom: 15px;'>
                                ...
                                <p style='margin: 0; color: #333; font-size: 15px; font-weight: 600;'>{$approvedBy}</p>
                            </div>
                        ...
                        <div style='background-color: #E8F5E9; border: 1px solid #C8E6C9; border-radius: 4px; padding: 20px; margin: 30px 0; text-align: center;'>
                            <p style='margin: 0 0 10px 0; color: #2E7D32; font-size: 14px; font-weight: 600;'>
                                ✓ Restructuring is now active
                            </p>
                            <p style='margin: 0; color: #558B2F; font-size: 13px;'>
                                All refund entries for the restructuring period have been created and set to restructured status.
                            </p>
                        </div>

                        <!-- Visit Site Button -->
                        <div style='text-align: center; margin: 30px 0;'>
                            <a href='http://192.168.0.7:8096/' style='display: inline-block; background: linear-gradient(135deg, #4CAF50 0%, #2E7D32 100%); color: #ffffff; text-decoration: none; padding: 14px 40px; border-radius: 4px; font-weight: 600; font-size: 15px; box-shadow: 0 2px 8px rgba(76,175,80,0.3);'>
        ...
        return $this->subject('[SETUPSYS] Restructuring Approved - ' . $projectTitle)
                    ->html($htmlContent);
    }
}