...
class ApplyRestructureMail extends Mailable
{
    ...
    public function build()
    {
            ...
            <body style='margin: 0; padding: 0; background-color: #f5f7fa; font-family: -apple-system, BlinkMacSystemFont, \"Segoe UI\", Roboto, \"Helvetica Neue\", Arial, sans-serif;'>
                <div style='max-width: 600px; margin: 0 auto; background-color: #ffffff;'>
                    ...
                    <div style='background: linear-gradient(135deg, #0056b3 0%, #003d82 100%); padding: 40px 20px; text-align: center;'>
                        ...
                        <h1 style='margin: 0; color: #ffffff; font-size: 28px; font-weight: 600;'>New Project Restructure Application</h1>
                    ...
                    <div style='padding: 40px 30px;'>
                        <p style='margin: 0 0 30px 0; color: #555; font-size: 16px;'>
                            Hello,<br><br>
                            A new project restructure application has been submitted and requires your review.
                        </p>
                        ...
                        <div style='background-color: #f8f9fa; border-left: 4px solid #0056b3; padding: 20px; margin: 30px 0; border-radius: 4px;'>
                            <h3 style='margin: 0 0 15px 0; color: #0056b3; font-size: 16px; font-weight: 600;'>Submission Details</h3>
                            ...
                            <div style='margin-bottom: 15px;'>
                                ...
                                <p style='margin: 0; color: #333; font-size: 15px; font-weight: 600;'>{$submittedBy}</p>
                            </div>
                        ...
                        <!-- Documents Section -->
                        <div style='background-color: #f8f9fa; border-left: 4px solid #0056b3; padding: 20px; margin: 30px 0; border-radius: 4px;'>
                            <h3 style='margin: 0 0 15px 0; color: #0056b3; font-size: 16px; font-weight: 600;'>Attached Documents</h3>
        ...
        return $this->subject('[SETUPSYS] New Project Restructure Application - ' . $projectTitle)
                    ->html($htmlContent);
    }
}