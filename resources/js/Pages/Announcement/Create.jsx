        ...
        <div className="mb-4 md:mb-8">
          ...
          <div className="flex flex-col md:flex-row md:items-center gap-3 md:gap-4">
            ...
            <div className="min-w-0 flex-1">
              <h1 className="text-xl md:text-3xl font-bold text-gray-900">Create Announcement</h1>
              <p className="text-xs md:text-sm text-gray-600 mt-0.5 md:mt-1">Will be linked to your office automatically</p>
            </div>
          </div>
        </div>

        {/* Form */}
        <div className="space-y-3 md:space-y-6" onSubmit={handleSubmit} component="form">
          {/* Details Section */}
            ...
            <div className="space-y-4 md:space-y-6">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 mt-1">
                  {data.details.length}/150 characters
                </p>
                {errors.details && (
                  <div className="text-red-500 text-xs md:text-sm mt-1 flex items-start gap-1">
                    <AlertCircle className="w-3 h-3 md:w-4 md:h-4 mt-0.5 flex-shrink-0" />
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 mb-1 md:mb-2">When will the announcement appear</p>
                <input
                  type="date"
                  className="w-full px-3 md:px-4 py-2 md:py-3 text-xs md:text-sm border border-gray-200 rounded-lg md:rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-gray-50 focus:bg-white transition-all"
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 mb-1 md:mb-2">When will the announcement disappear</p>
                <input
                  type="date"
                  className="w-full px-3 md:px-4 py-2 md:py-3 text-xs md:text-sm border border-gray-200 rounded-lg md:rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-gray-50 focus:bg-white transition-all"
                  value={data.end_date}
          ...
          <div className="bg-white rounded-lg md:rounded-2xl shadow-md md:shadow-xl p-4 md:p-8 border border-gray-100">
            <div className="mb-4 md:mb-0 md:flex md:items-center md:justify-between gap-4">
              <div className="mb-4 md:mb-0">
                <h3 className="text-base md:text-lg font-semibold text-gray-900">Ready to Post?</h3>
