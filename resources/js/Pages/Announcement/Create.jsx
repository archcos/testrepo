        ...
        <div className="mb-4 md:mb-8">
          ...
          <div className="flex flex-col md:flex-row md:items-center gap-3 md:gap-4">
            ...
            <div className="min-w-0 flex-1">
              <h1 className="text-xl md:text-3xl font-bold">Create Announcement</h1>
              <p className="text-xs md:text-sm mt-0.5 md:mt-1">Will be linked to your office automatically</p>
            </div>
          </div>
        </div>
