          ...
          <div className="bg-white rounded-lg md:rounded-2xl shadow-md md:shadow-xl p-4 md:p-8 border border-gray-100">
            <div className="flex items-center justify-between gap-2 md:gap-3 mb-4 md:mb-6 flex-wrap">
              ...
              <button
                type="button"
                onClick={addActivity}
                className="inline-flex items-center gap-1 md:gap-2 px-2 md:px-4 py-1.5 md:py-2 text-xs md:text-sm font-medium text-blue-600 bg-blue-50 hover:bg-blue-100 rounded-lg md:rounded-xl transition-colors duration-200 flex-shrink-0"
              >
                ...
                <div key={index} className="relative border-2 border-gray-100 rounded-lg md:rounded-xl p-3 md:p-6 bg-gradient-to-r from-gray-50 to-gray-50/30 hover:shadow-md transition-shadow duration-200">
                  ...
                  <div className="flex items-start justify-between gap-2 md:gap-3 mb-3 md:mb-4">
                    <div className="flex items-start gap-2 md:gap-3 min-w-0">
                      <div className="flex items-center justify-center w-8 h-8 md:w-10 md:h-10 bg-gradient-to-r from-blue-500 to-blue-600 text-white rounded-lg md:rounded-xl text-xs md:text-sm font-bold shadow-sm flex-shrink-0">
                        {index + 1}
                      </div>
                      <div className="min-w-0">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-3 md:gap-6">
                    ...
                    <div className="md:col-span-1">
                      ...
                      <input
                        ...
                        maxLength={45}
                        className="w-full px-3 md:px-4 py-2 md:py-3 text-sm md:text-base border border-gray-200 rounded-lg md:rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 bg-white"
                        required
                      />
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-3 md:px-4 py-2 md:py-3 text-sm md:text-base border text-black border-gray-200 rounded-lg md:rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 bg-white"
                        required
                      />
                    </div>
