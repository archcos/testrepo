            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    type="text"
                    className="w-full pl-10 pr-4 py-3 border border-gray-200 rounded-xl bg-gray-100 text-gray-700 font-mono focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200"
                    value={data.project_id}
                    readOnly
                    title="Format: YYYYMM## (Year-Month-Increment)"
                  />
                </div>
                <p className="text-xs text-gray-500 mt-1">Format: YYYYMM## (e.g., 20250142 = 2025, January, 42nd project)</p>
                {errors.project_id && (
                  <div className="text-red-500 text-sm mt-1 flex items-center gap-1">
                    <AlertCircle className="w-4 h-4" />
                    {errors.project_id}
